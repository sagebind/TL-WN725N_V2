USER_EXTRA_CFLAGS += -Wno-error=date-time -Dstrnicmp=strncasecmp
USER_EXTRA_CFLAGS += -DSTATION_INFO_SIGNAL=BIT\(NL80211_STA_INFO_SIGNAL\)
USER_EXTRA_CFLAGS += -DSTATION_INFO_TX_BITRATE=BIT\(NL80211_STA_INFO_TX_BITRATE\)
USER_EXTRA_CFLAGS += -DSTATION_INFO_TX_PACKETS=BIT\(NL80211_STA_INFO_TX_PACKETS\)
USER_EXTRA_CFLAGS += -DSTATION_INFO_RX_PACKETS=BIT\(NL80211_STA_INFO_RX_PACKETS\)
USER_EXTRA_CFLAGS += -DSTATION_INFO_ASSOC_REQ_IES=1<<17
